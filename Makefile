...
all:format clean dir gen build-linux build-linux-arm build-darwin build-darwin-arm build-windows install-cyclonedx install-micromatch-wrapper copy tests
